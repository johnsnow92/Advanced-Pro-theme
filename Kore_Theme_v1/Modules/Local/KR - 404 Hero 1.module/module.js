$(function() {
  ...
  $( ".kore-404-hero-v1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-404-hero-v1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-404-hero-v1 .parent [style]").each(function() { 
  ...
  $('.kore-404-hero-v1 a[href*=#]').click(function() {
