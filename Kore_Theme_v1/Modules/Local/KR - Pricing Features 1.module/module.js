$(function() {
  ...
  $( ".kore-pricing-features-1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-pricing-features-1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-pricing-features-1 .parent [style]").each(function() { 
  ...
  $('.kore-pricing-features-1 a[href*=#]').click(function() {
  ...
  $('.kore-pricing-features-1__cta aa[href^="#"]').on('click',function(e){
    e.preventDefault();   
