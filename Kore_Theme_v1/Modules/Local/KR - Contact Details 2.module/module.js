$(function() {
  ...
  $( ".kore-contact-details-v2 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-contact-details-v2 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-contact-details-v2 .parent [style]").each(function() { 
  ...
  $('.kore-contact-details-v2 a[href*=#]').click(function() {
