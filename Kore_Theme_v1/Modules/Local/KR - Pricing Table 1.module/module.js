$(function() {
  ...
  $( ".kore-pricing-table-1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-pricing-table-1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $( ".kore-pricing-table-1 .parent [style]" ).each(function() { 
  ...
  $('.kore-pricing-table-1 a[href*=#]').click(function() {
