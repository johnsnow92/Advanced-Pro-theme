$(function() {
  ...
  $(".kore-boldcast-testimonial").closest(".hs_cos_wrapper_type_module").addClass("kore-boldcast-testimonial-wrap");

  $( ".kore-boldcast-testimonial .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-boldcast-testimonial .parent table" ).addClass( "table table-hover table-bordered" );
  
  $( ".kore-boldcast-testimonial .parent [style]" ).each(function() { 
  ...
  $('.kore-boldcast-testimonial .customer-testimonial').slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 6000,
