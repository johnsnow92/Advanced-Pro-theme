$(function() {
  ...
  $( ".kore-lp-cta-1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-lp-cta-1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $( ".kore-lp-cta-1 .parent [style]" ).each(function() { 
  ...
  $('.kore-lp-cta-1 a[href*=#]').click(function() {
