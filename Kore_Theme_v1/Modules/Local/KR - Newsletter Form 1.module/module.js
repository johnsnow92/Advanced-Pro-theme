$(function() {
  ...
  $( ".kore-newsletter-1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-newsletter-1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-newsletter-1 .parent [style]").each(function() { 
  ...
  $('.kore-newsletter-1 a[href*=#]').click(function() {
