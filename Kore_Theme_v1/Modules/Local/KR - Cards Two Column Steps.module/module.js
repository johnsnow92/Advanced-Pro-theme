$(function() {
  ...
  $( ".kore-cd-2-col-steps .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-cd-2-col-steps .parent table" ).addClass( "table table-hover table-bordered" );
  
  $( ".kore-cd-2-col-steps .parent [style]" ).each(function() { 
  ...
  $('.kore-cd-2-col-steps a[href*=#]').click(function() {
