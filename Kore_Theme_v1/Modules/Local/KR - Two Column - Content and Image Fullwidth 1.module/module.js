$(function() {
  ...
  $( ".kore-col2-content-imge-fw .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-col2-content-imge-fw .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-col2-content-imge-fw .parent [style]").each(function() { 
  ...
  $('.kore-col2-content-imge-fw a[href*=#]').click(function() {
