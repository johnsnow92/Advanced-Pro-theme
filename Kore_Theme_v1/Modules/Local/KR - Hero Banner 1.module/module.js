$(function() {
  ...
  $( ".kore-hero-banner-1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-hero-banner-1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-hero-banner-1 .parent [style]").each(function() { 
  ...
  $('.kore-hero-banner-1 a[href*=#]').click(function() {
