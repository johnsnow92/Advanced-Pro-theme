$(function() {
  ...
  $( ".kore-banner .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-banner .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-banner .parent [style]").each(function() { 
  ...
  $('.kore-banner a[href*=#]').click(function() {
