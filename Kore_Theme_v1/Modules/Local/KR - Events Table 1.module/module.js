$(function() {
  ...
  $( ".kore-event-table-1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-event-table-1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-event-table-1 .parent [style]").each(function() { 
  ...
  $('.kore-event-table-1 a[href*=#]').click(function() {
