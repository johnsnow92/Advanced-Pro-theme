$(function() {
  ...
  $( ".kr-cards-col3-section1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kr-cards-col3-section1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kr-cards-col3-section1 .parent [style]").each(function() { 
  ...
  $('.kr-cards-col3-section1 a[href*=#]').click(function() {
