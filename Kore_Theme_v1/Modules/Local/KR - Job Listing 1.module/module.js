$(function() {
  ...
  $( ".kore-job-listing-1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-job-listing-1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-job-listing-1 .parent [style]").each(function() { 
  ...
  $('.kore-job-listing-1 a[href*=#]').click(function() {
