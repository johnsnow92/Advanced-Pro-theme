$(function() {
  ...
  $( ".kore-pricing-table-3 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-pricing-table-3 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $( ".kore-pricing-table-3 .parent [style]" ).each(function() { 
  ...
  $('.kore-pricing-table-3 a[href*=#]').click(function() {
