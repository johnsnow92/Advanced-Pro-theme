$(function() {
  ...
  $('.kore-lp-two-column-with-lists-scroll a[href*=#]').click(function() {
  ...
  $( ".kore-lp-two-column-with-lists-scroll .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-lp-two-column-with-lists-scroll .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-lp-two-column-with-lists-scroll .parent [style]").each(function() { 
