$(function() {
  ...
  $('.hub-video-slider-wrapper').slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 6000,
  ...
  $( ".kore-lp-richtext-1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-lp-richtext-1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-lp-richtext-1 .parent [style]").each(function() { 
  ...
  $('.kore-lp-richtext-1 a[href*=#]').click(function() {
