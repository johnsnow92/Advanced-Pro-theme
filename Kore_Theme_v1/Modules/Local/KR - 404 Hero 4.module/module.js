$(function() {
  ...
  $( ".kore-404-hero-v4 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-404-hero-v4 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-404-hero-v4 .parent [style]").each(function() { 
  ...
  $('.kore-404-hero-v4 a[href*=#]').click(function() {
