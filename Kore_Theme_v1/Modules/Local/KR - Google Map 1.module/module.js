$(function() {
  ...
  $( ".kore-google-map-1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-google-map-1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-google-map-1 .parent [style]").each(function() { 
  ...
  $('.kore-google-map-1 a[href*=#]').click(function() {
