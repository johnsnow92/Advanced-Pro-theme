$(function() {
  ...
  $( ".kr-col3-cards-section-1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kr-col3-cards-section-1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kr-col3-cards-section-1 .parent [style]").each(function() { 
  ...
  $('.kr-col3-cards-section-1 a[href*=#]').click(function() {
