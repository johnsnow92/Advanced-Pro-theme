$(function() {
  ...
  $( ".kore-social-proof .parent table" ).wrap( "<div class='table-responsive'></div>" );

  $( ".kore-social-proof .parent table" ).addClass( "table table-hover table-bordered" );

  $(".kore-social-proof .parent [style]").each(function() { 
  ...
  $('.kore-social-proof a[href*=#]').click(function() {
