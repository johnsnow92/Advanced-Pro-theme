$(function() {
  ...
  $( ".kore-lp-social-share-v2 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-lp-social-share-v2 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-lp-social-share-v2 .parent [style]").each(function() { 
  ...
  $('.kore-lp-social-share-v2 a[href*=#]').click(function() {
