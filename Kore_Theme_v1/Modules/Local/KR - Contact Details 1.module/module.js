$(function() {
  ...
  $( ".kore-contact-details-1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-contact-details-1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-contact-details-1 .parent [style]").each(function() { 
  ...
  $('.kore-contact-details-1 a[href*=#]').click(function() {
