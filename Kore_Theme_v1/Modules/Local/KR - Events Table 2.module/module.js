$(function() {
  ...
  $( ".kore-event-table-2 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-event-table-2 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-event-table-2 .parent [style]").each(function() { 
  ...
  $('.kore-event-table-2 a[href*=#]').click(function() {
