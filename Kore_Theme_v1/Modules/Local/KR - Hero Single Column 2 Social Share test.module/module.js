$(function() {
  ...
  $( ".kore-lp-social-share-v1 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-lp-social-share-v1 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-lp-social-share-v1 .parent [style]").each(function() { 
  ...
  $('.kore-lp-social-share-v1 a[href*=#]').click(function() {
