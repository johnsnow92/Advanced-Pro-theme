$(function() {
  ...
  $( ".kr-table-2 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kr-table-2 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kr-table-2 .parent [style]").each(function() { 
  ...
  $('.kr-table-2 a[href*=#]').click(function() {
