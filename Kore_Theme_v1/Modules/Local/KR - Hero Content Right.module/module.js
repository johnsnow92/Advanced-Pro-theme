$(function() {
  ...
  $( ".kore-error-page-banner .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-error-page-banner .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-error-page-banner .parent [style]").each(function() { 
  ...
  $('.kore-error-page-banner a[href*=#]').click(function() {
