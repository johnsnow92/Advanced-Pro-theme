$(function() {
  ...
  $( ".kore-cards-section .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-cards-section .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-cards-section .parent [style]").each(function() { 
  ...
  $('.kore-cards-section a[href*=#]').click(function() {
