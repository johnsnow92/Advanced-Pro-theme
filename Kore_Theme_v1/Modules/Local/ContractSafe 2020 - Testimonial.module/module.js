$(function() {
  ...
  $( ".contractsafe-2020-testimonial .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".contractsafe-2020-testimonial .parent table" ).addClass( "table table-hover table-bordered" );
  
  $( ".contractsafe-2020-testimonial .parent [style]" ).each(function() { 
  ...
  $('.contractsafe-2020-testimonial .customer-testimonial').slick({
    slidesToShow: 2,
    slidesToScroll: 2,
    autoplay: true,
    autoplaySpeed: 6000,
