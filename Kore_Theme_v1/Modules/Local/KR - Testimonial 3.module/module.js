$(function() {
  ...
  $(".kore-testimonial-3").closest(".hs_cos_wrapper_type_module").addClass("kore-boldcast-testimonial-wrap");

  $( ".kore-testimonial-3 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-testimonial-3 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $( ".kore-testimonial-3 .parent [style]" ).each(function() { 
  ...
  $('.kore-testimonial-3 .customer-testimonial').slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 6000,
