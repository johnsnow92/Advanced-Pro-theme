$(function() {
  ...
  $( ".kore-pricing-features-2 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-pricing-features-2 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-pricing-features-2 .parent [style]").each(function() { 
  ...
  $('.kore-pricing-features-2 a[href*=#]').click(function() {
  ...
  $('.kore-pricing-features-2__cta aa[href^="#"]').on('click',function(e){
    e.preventDefault();   
