$(function() {
  ...
  $( ".kore-richtext-sidebar .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-richtext-sidebar .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-richtext-sidebar .parent [style]").each(function() { 
  ...
  $('.kore-richtext-sidebar a[href*=#]').click(function() {
