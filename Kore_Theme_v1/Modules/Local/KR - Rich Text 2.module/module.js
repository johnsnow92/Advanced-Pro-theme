$(function() {
  ...
  $( ".kore-lp-richtext-2 .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-lp-richtext-2 .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-lp-richtext-2 .parent [style]").each(function() { 
  ...
  $('.kore-lp-richtext-2 a[href*=#]').click(function() {
