$(function() {
  ...
  $( ".kore-video-wide .parent table" ).wrap( "<div class='table-responsive'></div>" );
  
  $( ".kore-video-wide .parent table" ).addClass( "table table-hover table-bordered" );
  
  $(".kore-video-wide .parent [style]").each(function() { 
  ...
  $('.kore-video-wide a[href*=#]').click(function() {
