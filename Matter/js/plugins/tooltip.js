function initPopperTooltip(target, tooltipWrapper, options={}) {
  var arrow = document.createElement("div");
  arrow.setAttribute("data-popper-arrow", null);
  
  tooltipWrapper.forEach(function(tooltipWrap) {
    var tooltip = tooltipWrap.querySelector(".pwr-tooltip__text");

    tooltip.append(arrow);
    var popperInstance = Popper.createPopper(target, tooltip, options);
    function show() {
      tooltipWrap.setAttribute("data-show", ""),
    ...
    function hide() {
      tooltipWrap.removeAttribute("data-show"),
        popperInstance.setOptions(function(options){
        return {
          ...options,
          modifiers: [...options.modifiers, {
...
function setPopperTooltipText(target, textHtml, options, tooltipParent) {
  var parent = tooltipParent || target
  , tooltipWrapper = document.createElement("div");
  tooltipWrapper.classList.add("pwr-tooltip__text-wrapper");
  var tooltip = document.createElement("div");
  tooltip.classList.add("pwr-tooltip__text");
  var tooltipText = document.createElement("span");
  tooltipText.innerHTML = textHtml,
    tooltip.append(tooltipText),
    tooltipWrapper.append(tooltip),
    parent.append(tooltipWrapper),
    parent.classList.add("pwr-tooltip"),
    initPopperTooltip(target, tooltipWrapper, options)
}
!function(e, t) {
    ...
    var pe = {
      ...
      fn: function(e) {
        ...
        if (!t.modifiersData[r]._skip) {
          for (var o = n.mainAxis, i = void 0 === o || o, a = n.altAxis, s = void 0 === a || a, f = n.fallbackPlacements, c = n.padding, p = n.boundary, u = n.rootBoundary, l = n.altBoundary, d = n.flipVariations, h = void 0 === d || d, m = n.allowedAutoPlacements, v = t.options.placement, g = C(v), y = f || (g !== v && h ? function(e) {
            if (C(e) === L)
              return [];
            var t = ae(e);
            return [fe(e), t, fe(t)]
          }(v) : [ae(v)]), b = [v].concat(y).reduce((function(e, n) {
